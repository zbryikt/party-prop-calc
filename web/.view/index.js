...
var og = {
  ...
  description: "人氣小黨如綠黨有一定比例的支持度，如果我們將泛綠的政黨票分一部份給他們，會如何影響不分區立委的結果呢？",
...
;pug_debug_line = 100;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + " ( 數據為隨意生成 )，與其對應的不分區立委席次分配。在此例中，已有相當人數支持台灣基進與綠黨，兩者總和甚至超過 5% ，足夠支持一個小黨越過門檻，可惜票源分散，使得兩黨皆無法獲得不分區席次。\u003C\u002Fp\u003E";
...
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 105;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + "由於小黨越過 5% 門檻，瞬間獲得了 6 個不分區立委席次。民進黨則因為票源分配減少 4 席。總地來說，泛綠陣營的總席次由 20 席提升至 22 席，同時國民黨席次甚至減少 2 席，雙方差距拉大至 10 席，真是賺翻了！\u003C\u002Fp\u003E";
...
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 117;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + "在這種情況下，泛綠陣營受到門檻影響最大，將近 19.6% 的選票被不分區分配忽略了。同樣的選票數，原本可以與國民黨拉至 12 席的差距，現在竟然以 15 比 19 敗陣了！\u003C\u002Fp\u003E";
